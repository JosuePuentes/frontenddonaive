...
export const AD_ROUTE_ACCESS_RULES: AdRouteAccessRule[] = [
  ...
  { prefix: "/cuentas", anyOf: ["accounts.open", "accounts.serve"] },
  ...
  { prefix: "/finanzas/conciliacion", anyOf: ["finance.reconcile", "finance.manage"] },
  { prefix: "/finanzas/movimientos", anyOf: ["finance.view"] },
  { prefix: "/finanzas/configuracion", anyOf: ["finance.manage"] },
  { prefix: "/finanzas", anyOf: ["finance.dashboard.view", "finance.manage"] },
  { prefix: "/promociones", anyOf: ["promotions.manage"] },
  { prefix: "/productos", anyOf: ["inventory.read", "settings.manage", "products.manage"] },
  { prefix: "/presentaciones", anyOf: ["inventory.read", "settings.manage", "pricing.manage"] },
  ...
  { prefix: "/mesonera", anyOf: ["accounts.serve", "tables.manage"] },
  { prefix: "/mesas", anyOf: ["tables.manage"] },
  { prefix: "/escaner", anyOf: ["inventory.read", "pos.sell", "products.manage"] },
  { prefix: "/qr", anyOf: ["accounts.serve"] },
  { prefix: "/prepagos", anyOf: ["accounts.serve"] },
