...
export const DS_PERMISSION_LABELS: Record<DsPermission, string> = {
  ...
  "inventory.master.view": "Inventario máster · ver",
  "inventory.general.view": "Inventario general · ver",
  "inventory.general.export": "Inventario general · exportar",
  "pos.fiscal": "POS · facturar fiscal",
