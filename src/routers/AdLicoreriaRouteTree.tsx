...
const AdLicoreriaCompras = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaCompras"),
);
const AdLicoreriaComprasAnalisis = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaComprasAnalisis"),
);
const AdLicoreriaProveedores = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaProveedores"),
);
const AdLicoreriaImportacion = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaImportacion"),
);
const AdLicoreriaTasas = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaTasas"),
);
const AdLicoreriaFinanzas = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaFinanzas"),
);
const AdLicoreriaBancos = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaBancos"),
);
const AdLicoreriaMovimientos = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaMovimientos"),
);
const AdLicoreriaCasaCambio = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaCasaCambio"),
);
const AdLicoreriaConciliacion = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaConciliacion"),
);
const AdLicoreriaPromociones = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaPromociones"),
);
const AdLicoreriaConfigFinanciera = lazy(
  () => import("@/pages/ad-licoreria/AdLicoreriaConfigFinanciera"),
);
...
function adLicoreriaRouteTree(prefix: "" | "/licoreria"): ReactNode {
  ...
  return (
    <>
      ...
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "compras")}
        element={<AdLicoreriaCompras />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "comprasAnalisis")}
        element={<AdLicoreriaComprasAnalisis />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "proveedores")}
        element={<AdLicoreriaProveedores />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "importacion")}
        element={<AdLicoreriaImportacion />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "tasas")}
        element={<AdLicoreriaTasas />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "bancos")}
        element={<AdLicoreriaBancos />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "movimientos")}
        element={<AdLicoreriaMovimientos />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "casaCambio")}
        element={<AdLicoreriaCasaCambio />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "conciliacion")}
        element={<AdLicoreriaConciliacion />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "promociones")}
        element={<AdLicoreriaPromociones />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "configFinanciera")}
        element={<AdLicoreriaConfigFinanciera />}
      />
      <Route
        path={adLicoreriaRouterPath(prefix, "finanzas")}
        element={<AdLicoreriaFinanzas />}
      />
      <Route
