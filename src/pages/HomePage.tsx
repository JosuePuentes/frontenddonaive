                    ...
                    <div className="flex flex-col lg:flex-row items-start gap-8">
                        ...
                        <h1 className="font-bold text-white leading-tight mb-6 relative">
                            <div className="relative inline-block">
                                {/* Imagen de fondo con overlay de colores del proyecto */}
                                <div 
                                ...
                                >
                                    {/* Overlay con colores del fondo del proyecto */}
                                    <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-blue-900/70 to-indigo-900/80 rounded-lg"></div>
                                </div>
