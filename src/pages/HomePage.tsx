                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
                    <div className="flex flex-col lg:flex-row items-start gap-8">
                        ...
                        <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl leading-relaxed">
                            Transformamos y potenciamos los resultados de tu empresa con una combinación única de <span className="text-green-300">asesoría financiera</span> y <span className="text-green-300">desarrollo web</span>
                        </p>
